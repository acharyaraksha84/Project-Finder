...
import { Moon, Sun, Search, Sparkles, Heart, ExternalLink, Github, FileText, Database, Filter, Star } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold gradient-text">Project Finder</h1>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center space-y-6 animate-fade-in">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Explore projects from GitHub repositories, research papers, and datasets.
